                                ...
                                <ul class="nav nav-pills inv-list-container d-block" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <div class="nav-link list-actions"
                                            id="invoice-{{ $customer->transactions->first()->id }}"
                                            data-invoice-id="{{ sprintf('%08d', $customer->transactions->first()->id) }}">
                                            <div class="f-m-body">

                                                <div class="f-body">
                                                    <p class="invoice-number">Invoice
                                                        #{{ sprintf('%08d', $customer->transactions->first()->id) }}</p>
                                                    <p class="invoice-customer-name"><span>To:</span>
                                                        {{ $customer->name }}</p>
                                                    <p class="invoice-generated-date">Date:
                                                        {{ $customer->transactions->first()->created_at }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div class="invoice-container">
                        <div class="invoice-inbox">
                            ...
                            <div id="ct" class="">
                                ...
                                <div class="invoice-{{ $customer->transactions->first()->id }}">
                                    <div class="content-section  animated animatedFadeInUp fadeInUp">
                                        ...
                                        <div class="row inv--detail-section">
                                            ...
                                            <div class="col-sm-7 align-self-center">
                                                ...
                                                <p class="inv-customer-name">Customer Name : {{ $customer->name }}</p>
                                                <p class="inv-customer-name">Shop Name :
                                                    {{ $customer->customer_details->store_name }}</p>
                                                <p class="inv-street-addr">Customer Address :
                                                    {{ $customer->customer_details->address }}
                                                </p>
                                                <p class="inv-email-address">Customer Email : {{ $customer->email }}</p>
                                                <p class="inv-street-addr">
                                                    {{ $customer->customer_details->gstin? "Customer GSTIN# ".$customer->customer_details->gstin:"" }}
                                                </p>
                                                <p class="inv-street-addr">
                                                    {{ $customer->customer_details->gstin? "Customer Place of Supply: ".$customer->customer_details->pos:"" }}
                                                </p>
                                            </div>
                                            ...
                                            <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                ...
                                                <p class="inv-created-date"><span class="inv-title">Invoice Date :
                                                        ...
                                                        class="inv-date">{{ $customer->transactions->first()->created_at }}</span>
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>1</td>
                                                                <td>{{ $customer->customer_details->package->title }}
                                                                </td>
                                                                <td class="text-right">1</td>
                                                                <td class="text-right">
                                                                    ₹{{ $customer->customer_details->package->price }}
                                                                </td>
                                                                <td class="text-right">
                                                                    ₹{{ $customer->customer_details->package->price }}
                                                                </td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8 col-12">
                                                            <p class="">
                                                                ...
                                                                {{ $customer->transactions->first()->payment_type == 0 ? "Cash Payment" : ($customer->transactions->first()->payment_type == 1 ? "Payment Gateway" : ($customer->transactions->first()->payment_type == 2 ? "UPI" : ($customer->transactions->first()->payment_type == 3 ? "Internet banking" : ($customer->transactions->first()->payment_type == 4 ? "Paytm" :($customer->transactions->first()->payment_type == 5 ? "Commission Basis" : "N/A")))) ) }}
                                                                @endif
                                                        ...
                                                        <div class="col-sm-8 col-12">
                                                            <p class="">
                                                                {{ $customer->transactions->first()->transaction_id }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="inv--total-amounts text-sm-right">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 col-5">
                                                            <p class="">
                                                                ₹{{ $customer->transactions->first()->amount }}</p>
                                                        </div>
                                                        <div class="col-sm-8 col-7">
                                                        ...
                                                        <div class="col-sm-4 col-5">
                                                            <p class="">₹{{ $customer->transactions->first()->tax }}</p>
                                                        </div>
                                                        <div class="col-sm-8 col-7">
                                                        ...
                                                        <div class="col-sm-4 col-5 grand-total-amount">
                                                            <h4 class="">
                                                                ₹{{ $customer->transactions->first()->total_amount }}
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
